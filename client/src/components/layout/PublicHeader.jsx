          ...
          <div className="pub-header__inner">
            ...
            <div className="pub-header__right">
              <nav className={`pub-header__nav ${mobileMenuOpen ? 'open' : ''}`}>
                ...
                <button
                  type="button"
                  className="pub-header__link pub-header__mobile-notif-link"
                  onClick={() => {
                    setMobileMenuOpen(false);
                    if (!isAuthenticated) setLoginModalOpen(true);
                    else setInvitesModalOpen(true);
                  }}
                >
                  ...
                  {pendingInvites && pendingInvites.length > 0 && (
                    <span className="pub-header__bell-red-dot-static" />
                  )}
                </button>
              </nav>
              ...
              <button
                type="button"
                className="pub-header__bell-icon-btn"
                onClick={() => {
                  if (!isAuthenticated) setLoginModalOpen(true);
                  else setInvitesModalOpen(true);
                }}
                title={pendingInvites && pendingInvites.length > 0 ? `${pendingInvites.length} Pending Team Invitations` : 'Notifications'}
              ...
              >
                ...
                {pendingInvites && pendingInvites.length > 0 && (
                  <span className="pub-header__bell-red-dot" />
                )}
              </button>
